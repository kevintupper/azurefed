...
#***********************************************************************************************
MENU_ITEMS = [
    {"menu_title": "Home", "return_value": "home", "submenu": []},

    {"menu_title": "Azure OpenAI", "return_value": "aoai", "submenu": []},
...
async def home():
    ...
    # Set the page title
    st.title("Azure Fed Demo Environment")

    # Define page content.
    content = """
        ### Welcome
        This is the Azure Fed Demo Environment.

        Instructions for using the environment and how to customize it for your presentations.
...
async def aoai():
    """
    Display the side_by_side page.
    """
    st.title("Azure OpenAI Presentation Settings")

# Next 1 Page
async def demo_2_next_1():
    """
    Display the next 1 page.
    """
    st.title("Demo 2")
    st.write("This is the next 1 page.")
    st.markdown("### This is a markdown header")
    st.write("This is a text block.")

# Next 2 Page
async def demo_2_next_2():  
    """
    Display the next 2 page.
    """
    st.title("Demo 2")
    st.write("This is the next 2 page.")
